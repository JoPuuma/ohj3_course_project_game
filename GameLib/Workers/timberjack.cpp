...
Timberjack::Timberjack(const std::shared_ptr<Course::iGameEventHandler>& eventhandler,
...
std::string Timberjack::getType() const
{
    return "Timberjack";
}
...
const Course::ResourceMapDouble Timberjack::tileWorkAction()
{
