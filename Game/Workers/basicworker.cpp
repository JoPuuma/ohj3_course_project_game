...
basicWorker::basicWorker(const std::shared_ptr<Course::iGameEventHandler>& eventhandler,
...
bool basicWorker::canBePlacedOnTile(const std::shared_ptr<Course::TileBase> &target) const
{
...
const Course::ResourceMapDouble basicWorker::tileWorkAction()
{
